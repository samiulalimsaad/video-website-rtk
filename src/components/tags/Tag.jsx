...
export default function Tag({ tag }) {
    ...
    const style = isSelected
        ? "flex items-center bg-blue-600 text-white px-4 py-1 rounded-full cursor-pointer"
        : "flex items-center bg-blue-100 text-blue-600 px-4 py-1 rounded-full cursor-pointer";
